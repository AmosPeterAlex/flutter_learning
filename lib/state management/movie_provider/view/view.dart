import 'package:advanced_flutter/state%20management/movie_provider/view/wish_list.dart';
import 'package:flutter/material.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';
import 'package:provider/provider.dart';

import '../../../movie_cart_provider/provider/movie_provider.dart';
        ...
        ElevatedButton.icon(
            onPressed: () {
              Navigator.push((context),
                  MaterialPageRoute(builder: (context) => MovieWishList()));
            },
            icon: Icon(
              Icons.favorite,
              color: Colors.red,
